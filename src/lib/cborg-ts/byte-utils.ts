 ...
 * @returns {Uint8Array}
 */
export const fromArray = (arr: number[]): Uint8Array => {
 ...
 * @returns {Uint8Array}
 */
function toBytes(obj: Uint8Array | ArrayBuffer | ArrayBufferView): Uint8Array {
 ...
 * @returns {string}
 */
function utf8Slice(buf: Uint8Array, offset: number, end: number): string {
  const res = []
