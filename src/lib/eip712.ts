import { Type, Token } from './cborg-ts/token.js'
import type { TagDecoder } from './cborg-ts/interface.js'
import { jump, quick } from './cborg-ts/jump.js'
import { decodeErrPrefix } from './cborg-ts/common.js'
...
const decode = <T = unknown>(data: ByteView<T>, visitor?: (path: string[], value: unknown) => void): T =>
